...
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;">
				...
				<div style="max-width: 600px; display: block; margin: 0 auto;">
					<table style="width: 100%;"><tr>
<td>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Your name: </span>'.$name.'</p>
								...
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Adult guests: </span>'.$adults.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Children guests: </span>'.$children.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Check-in date: </span>'.$date_from.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Check-out date: </span>'.$date_to.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Comments: </span>'.$message.'</p>
							</td>
						</tr></table>
</div>
			</td>
